...
public class MLAListData {
    ...
    public HashMap<String,List<MLAListModel>> getlist()  {
        ...
        if(userType.equals("admin"))
        {
            ...
            List<MLAListModel> posts = new ArrayList<>();
            List<MLAListModel> friends = new ArrayList<>();
            List<MLAListModel> groups = new ArrayList<MLAListModel>();
            groups.add(new MLAListModel("Create Group"));
            groups.add(new MLAListModel("My Groups"));
            groups.add(new MLAListModel("Exit Group"));
            ...
            navDrawerHashMap.put("Posts", posts);
            navDrawerHashMap.put("Friends", friends);
            navDrawerHashMap.put("Groups", groups);
        ...
        else if (userType.equals("instructor"))
        {
            ...
            List<MLAListModel> posts = new ArrayList<MLAListModel>();
            List<MLAListModel> friends = new ArrayList<MLAListModel>();
            List<MLAListModel> groups = new ArrayList<MLAListModel>();
            groups.add(new MLAListModel("Create Group"));
            groups.add(new MLAListModel("My Groups"));
            groups.add(new MLAListModel("Exit Group"));
