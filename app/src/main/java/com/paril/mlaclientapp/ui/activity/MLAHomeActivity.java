...
import com.paril.mlaclientapp.ui.fragment.MLAFriendViewFragment;
...
import com.paril.mlaclientapp.ui.fragment.MLAGroupDeleteViewFragment;
import com.paril.mlaclientapp.ui.fragment.MLAGroupListViewFragment;
import com.paril.mlaclientapp.ui.fragment.MLAGroupViewFragment;
            ...
            public boolean onGroupClick(ExpandableListView expandableListView, View view, int groupPosition, long l) {
                if (expandableListView.getExpandableListAdapter().getChildrenCount(groupPosition) == 0) {
                    if (lastGroupSelPos != groupPosition) {
                        ...
                        else if (listPrimary.get(groupPosition).equals("Posts")) {
                            setToolbarTitle("New Posts");
                            MLAPostViewFragment mlaPostViewFragment = new MLAPostViewFragment();
                            FragmentManager fragmentManager = getFragmentManager();
                            FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
                            fragmentTransaction.replace(R.id.mla_fragmentholder,mlaPostViewFragment);
                            fragmentTransaction.commit();
                        }
                        else if (listPrimary.get(groupPosition).equals("Friends")) {
                            setToolbarTitle("Friends");
                            MLAFriendViewFragment mlaFriendViewFragment = new MLAFriendViewFragment();
                            FragmentManager fragmentManager = getFragmentManager();
                            FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
                            fragmentTransaction.replace(R.id.mla_fragmentholder, mlaFriendViewFragment);
                            fragmentTransaction.commit();
                        }
                        /*else if (listPrimary.get(groupPosition).equals("Groups")) {
                            setToolbarTitle("Groups");
                            MLAGroupViewFragment mlaFriendViewFragment = new MLAGroupViewFragment();
                            FragmentManager fragmentManager = getFragmentManager();
                            FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
                            fragmentTransaction.replace(R.id.mla_fragmentholder, mlaFriendViewFragment);
                            fragmentTransaction.commit();
        ...
        listExpandable.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                if (lastGroupSelPos != groupPosition || lastChildSelPos != childPosition) {
                    ...
                    } else if (listHashMap.get(listPrimary.get(groupPosition)).get(childPosition).getTxtView().equals("Create Group") && listPrimary.get(groupPosition).equals("Groups")) {
                        setToolbarTitle("Groups");
                        MLAGroupViewFragment mlagroupViewFragment = new MLAGroupViewFragment();
                        FragmentManager fragmentManager = getFragmentManager();
                        FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
                        fragmentTransaction.replace(R.id.mla_fragmentholder, mlagroupViewFragment);
                        fragmentTransaction.commit();
                    }
                    else if (listHashMap.get(listPrimary.get(groupPosition)).get(childPosition).getTxtView().equals("My Groups") && listPrimary.get(groupPosition).equals("Groups")) {
                        setToolbarTitle("Groups");
                        MLAGroupListViewFragment mlagrouplistViewFragment = new MLAGroupListViewFragment();
                        FragmentManager fragmentManager = getFragmentManager();
                        FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
                        fragmentTransaction.replace(R.id.mla_fragmentholder, mlagrouplistViewFragment);
                        fragmentTransaction.commit();
                    }
                    else if (listHashMap.get(listPrimary.get(groupPosition)).get(childPosition).getTxtView().equals("Exit Group") && listPrimary.get(groupPosition).equals("Groups")) {
                        setToolbarTitle("Groups");
                        MLAGroupDeleteViewFragment mlagrouplistViewFragment = new MLAGroupDeleteViewFragment();
                        FragmentManager fragmentManager = getFragmentManager();
                        FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
                        fragmentTransaction.replace(R.id.mla_fragmentholder, mlagrouplistViewFragment);
                        fragmentTransaction.commit();
